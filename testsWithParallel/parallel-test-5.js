...
describe('',  function() {
    ...
    //
    before(function () {
        console.log('---> test 5 before, mocha worker:', process.env.MOCHA_WORKER_ID)
    })
    ...
    after(function() {
        console.log('---> test 5 after, mocha worker:', process.env.MOCHA_WORKER_ID)
    })

    it('test-5', function() {
        console.log('test 5, mocha worker:', process.env.MOCHA_WORKER_ID)
    })
})